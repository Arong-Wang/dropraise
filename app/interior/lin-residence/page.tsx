...
export default function LinResidencePage() {
  const p = getProject("lin-residence");
      ...
      <section className="px-6 md:px-10 xl:px-16 2xl:px-24 pb-10">
        <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-8 items-end">
          <div className="overflow-hidden">
            <Image src={p.floorPlan.src} alt={p.title} width={0} height={0} sizes="(max-width: 1024px) 100vw, 60vw" className="w-full h-auto max-h-screen object-contain object-left translate-x-10" />
          </div>
